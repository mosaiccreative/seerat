...
const timelineItems = [
  ...
  { year: '1985', event: '"Khalaw \'ch Tangey Harf" published — open verse poetry' },
  { year: '1986', event: '"Bharam Bhullayan" published — stream-of-consciousness novel' },
  { year: '1987', event: 'JKAACL Award (Bharam Bhullayan); Selected for highest grade of college teachers in India' },
  { year: '1990', event: '"Kirchan" published — ghazals in pure form' },
  { year: '1991', event: 'JKAACL Best Punjabi Book Award (Kirchan)' },
  { year: '1992', event: 'Founded Punjabi Sahit Sabha California; "Kikkar Kande" published' },
  { year: '2002', event: 'Co-founded Vishav Punjabi Sahit Academy; "Surat Seerat Te Saraab" published' },
  { year: '2007', event: '"Saij Sullee Te Saleeb" published — open verse and ghazals' },
  { year: '2011', event: 'Sabbatical to focus on poetry full-time' },
  { year: '2014', event: '"Aroope Akhran da Aks" published — Professor Mohan Singh Award' },
  ...
  { year: '2017', event: '"Bharam Bhuleyan" 2nd Edition published; Sahir Ludhianvi Award (Chandigarh)' },
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/tishnagi" className="btn-minimal">
                Listen to Tishnagi
              </Link>
            </div>
          </motion.div>
